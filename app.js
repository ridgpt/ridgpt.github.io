...
async function analyzeContent(model, vocab, text) {
    ...
    return {
        text: aiProbability >= 0.5 
            ? 'generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>, and not written by a <span style="color: #34C759;">human</span>.' 
            : 'written by a <span style="color: #34C759;">human</span>, and not generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>.',
