...
async function analyzeContent(model, vocab, text) {
    ...
    return {
        text: aiProbability >= 0.5 
            ? 'generated by <span style="color: rgba(255, 0, 0, 1);">AI</span>, and not composed by a <span style="color: rgba(20, 78, 35, 1);">human</span>. <i class="fa-solid fa-gears"></i>' 
            : 'composed by a <span style="color: rgba(20, 78, 35, 1);">human</span>, and not generated by <span style="color: rgba(255, 0, 0, 1);">AI</span>. <i class="fa-solid fa-pen"></i>',
...
<button id="retrainBtn" style="margin-top: 0px; margin-bottom: 20px;">
    ...
    <h6 class="small" style="margin-top:0px;">Only attempt to refine the content checker when delayed results and/or inaccurate results become frequent. <i class="fa-solid fa-circle-info"></i></h6>
            ...
            <h6 style="margin-bottom: 0px; opacity: 1;"><i class="fa-solid fa-chevron-right gradient-icon"></i> <span style="opacity: 0.8;"> <span style="color: rgba(20, 78, 35, 1);">Human</span> Involvement: ${analysisResult.humanPercentage}% <i class="fa-solid fa-brain"></i></span></h6>
