...
document.getElementById('checkBtn').addEventListener('click', async function() {
    ...
    try {
        ...
        resultElement.innerHTML = `
            <button id="retrainBtn" style="margin-top: 0px; margin-bottom: 20px; font-size: 1.1em;">Refine Content Checker <i class="fa-solid fa-arrows-rotate"></i><h6 class="small">Only attempt to refine the content checker if you believe that the given results are 100% inaccurate. <i class="fa-solid fa-circle-info"></i></h6></button>
