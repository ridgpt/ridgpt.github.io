...
async function analyzeContent(model, vocab, text) {
    ...
    return {
        text: aiProbability >= 0.5 
            ? '<span class="reshed">Results</span> generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>, and not written by a <span style="color: #34C759;">human</span>. <i class="fa-solid fa-gears"></i>' 
            : '<span class="reshed">Results</span> written by a <span style="color: #34C759;">human</span>, and not generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>. <i class="fa-solid fa-pen"></i>',
