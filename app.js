...
document.getElementById('checkBtn').addEventListener('click', async function() {
    ...
    try {
        ...
        resultElement.innerHTML = `
            <h6 class="reshed" style=" background: linear-gradient(145deg, #007aff, #0051a3); background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Results <i class="fa-solid fa-chevron-down"></i></h6>
