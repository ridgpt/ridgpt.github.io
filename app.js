...
async function analyzeContent(model, vocab, text) {
    ...
    return {
        text: aiProbability >= 0.5 
            ? 'generated by <span style="color: #FF0000;">AI</span>, and not composed by a <span style="color: #34C759;">human</span>. <i class="fa-solid fa-gears"></i>' 
            : 'composed by a <span style="color: #34C759;">human</span>, and not generated by <span style="color: #FF0000;">AI</span>. <i class="fa-solid fa-pen"></i>',
