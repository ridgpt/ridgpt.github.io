...
async function analyzeContent(model, vocab, text) {
    ...
    const textResult = aiProbability >= 0.5 
        ? 'generated by Artificial Intelligence (AI) and not written by a human.' 
        : 'written by a human and not generated by Artificial Intelligence (AI).';

    // Typing animation
    const resultElement = document.getElementById('result');
    typeText(resultElement, `This content was ${textResult}`, 50);
