...
async function analyzeContent(model, vocab, text) {
    ...
    return {
        text: aiProbability >= 0.5 
            ?'<span style="opacity: 0.8;>generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>, and not written by a <span style="color: #34C759;">human</span>. <i class="fa-solid fa-gears"></i></span>' 
            : '<span style="opacity: 0.8;>written by a <span style="color: #34C759;">human</span>, and not generated by <span style="color: #FF0000;">Artificial Intelligence (AI)</span>. <i class="fa-solid fa-pen"></i></span>',
    ...
    try {
        ...
        resultElement.innerHTML = `
         <button id="retrainBtn" style="margin-top: 0px; margin-bottom: 20px;">Reload Content Checker <i class="fa-solid fa-arrows-rotate"></i> <h6 class="small">Only reload the content checker if you believe that the given result is 100% inaccurate. <i class="fa-solid fa-circle-info"></i></h6></button>
                ...
                <span style="opacity: 0.8;>This content was</span> ${analysisResult.text} 
            <hr>
             <span style="opacity: 0.8;>      <span style="color: #FF0000; margin-bottom: 20px;">Artificial Intelligence (AI)</span> Involvement: ${analysisResult.aiPercentage}% <i class="fa-solid fa-robot"></i></span>
 <span style="opacity: 0.8;><span style="color: #34C759;">Human</span> Involvement: ${analysisResult.humanPercentage}% <i class="fa-solid fa-brain"></i></span>
