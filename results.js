...
// Function to calculate the Levenshtein distance
        ...
        function findClosestMatch(input) {
            const threshold = 25; // Adjust the threshold as needed
            let closestMatches = [];
    ...
    container.classList.remove('result-visible');
    ...
    // Show the result container only if there is result or suggestion text
    if (resultText || suggestionsElement.innerHTML) {
